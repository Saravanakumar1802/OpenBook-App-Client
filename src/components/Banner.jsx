        ...
        <div className='px-4 lg:px-24 bg-teal-100 flex items-center'>
            <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40'>
                ...
                <div className='md:w-1/2 space-y-8 h-full'>
                    ...
                    <p className='md:w-4/5'>Unlock great deals on your favorite books! Buy and sell your literary treasures
                        at the best prices, creating a seamless marketplace for book enthusiasts to connect and exchange stories.</p>
                    <div>
                        <input type="text" name="search" id="search" placeholder='Search a book'
                            className='py-1.5 px-2 rounded-s-sm round-s-sm outline-none' />
